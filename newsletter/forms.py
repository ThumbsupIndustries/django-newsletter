...
class NewsletterForm(forms.ModelForm):
    ...
    name_field = forms.CharField(label=_("Name"), widget=forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'id':'name', 'placeholder': 'Full Name'}))
    email_field = forms.EmailField(label=_("E-Mail"), widget=forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'id': 'email', 'placeholder': 'E-Mail'}), validators=[validate_email_nouser], required=True)
